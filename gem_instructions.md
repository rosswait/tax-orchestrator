...
These tables are designed to be copied and pasted directly into a master Tax Projection Excel workbook. Do not add any conversational filler, introductory text, or concluding remarks. Output **only** the requested tables.
...
| Quarter | Entity | Ordinary Dividends | Qualified Dividends | Short-Term Gains | Long-Term Gains | Tax-Exempt Interest |
|---|---|---|---|---|---|---|
...
*   **Ordinary Dividends**: **Year-to-Date (YTD)** total non-qualified or ordinary dividends.
*   **Qualified Dividends**: **Year-to-Date (YTD)** total qualified dividends (these receive preferential tax rates).
...
*   **Tax-Exempt Interest**: **Year-to-Date (YTD)** interest explicitly marked as tax-exempt (e.g., Municipal bonds).
